  ...
  return (
    <div>
      ...
      <div className="mt-2 flex justify-between">
        {MONTHS.map((m) => (
          <span key={m} className="text-xs text-[#717680]">
            {m}
          </span>
        ))}
      </div>
  ...
  return (
    <div className="rounded-xl border border-[#E9EAEB] bg-white">
        ...
        <tbody>
          {type === "character"
            ? MOCK_CHARACTER_RANKING.map((item) => (
                ...
                >
                  <td className="px-4 py-4 text-sm text-[#181D27]">{item.rank}</td>
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-[#181D27]">{item.name}</p>
                        <p className="text-xs text-[#535862]">{item.tags}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4 text-sm text-[#535862]">{item.date}</td>
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      <button type="button" className="text-[#717680] hover:text-[#181D27]">
                        <Pencil className="size-4" />
                      </button>
                      <button type="button" className="text-[#717680] hover:text-red-500">
            ...
            : MOCK_CREATOR_RANKING.map((item) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-sm text-[#535862]">yyyy.mm.dd</td>
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      <button type="button" className="text-[#717680] hover:text-[#181D27]">
                        <Pencil className="size-4" />
      ...
      <div className="flex items-center justify-between border-t border-[#E9EAEB] px-6 py-3">
        <button type="button" className="rounded-lg border border-[#D5D7DA] px-4 py-2 text-sm">
          이전
        </button>
    ...
    <div className="max-w-[1200px] p-8">
      ...
      <div className="mb-8 grid grid-cols-3 gap-4">
        ...
        <MetricCard
          ...
          positive={false}
        />
        <MetricCard heading="시스템 상태" number="정상" showChart={false} />
      </div>
