        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#E9EAEB]">
              ...
              {!selectedReport && <th className="px-4 py-3 text-left text-xs font-medium text-[#717680]">일시</th>}
          ...
          <tbody>
            {MOCK_REPORTS.map((report) => (
              <tr key={report.id} className="border-b border-[#E9EAEB] last:border-0">
                ...
                {!selectedReport && <td className="px-4 py-4 text-sm text-[#535862]">{report.datetime}</td>}
